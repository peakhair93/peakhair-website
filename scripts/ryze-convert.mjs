...
const origin = 'https://peakhairtransplant.com';
...
:root{--paper:#F3EFE6;--paper-soft:#EAE4D6;--forest:#1E3B2E;--forest-deep:#152B21;--sage:#5C7263;--sand:#C9A25E;--white:#FCFAF4}
...
function page(title, description, canonical, main) {
  return `${marker}\n<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${escape(title)}</title><meta name="description" content="${escape(description)}"><link rel="canonical" href="${escape(canonical)}"><style>${stylesheet}</style></head><body><header class="sitehead"><div class="wrap"><a href="/" aria-label="Peak Hair Restoration home"><img src="/assets/peak-logo-2x.png" alt="Peak Hair Restoration"></a><nav><a href="/">Home</a><a href="/blog">Articles</a><a href="/#contact">Free consultation</a></nav></div></header><main>${main}</main><footer class="sitefoot"><div class="wrap"><span>Peak Hair Restoration</span><a href="/#contact">Request an assessment</a></div></footer></body></html>\n`;
}
